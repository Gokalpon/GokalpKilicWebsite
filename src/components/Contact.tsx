...
export function Contact() {
  ...
  const marqueeText = t("Let's Build", "Hadi İnşa Edelim");
  ...
  return (
    <section ref={container} id="contact" className="relative py-32 md:py-48 bg-white overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-10 text-center">
          <motion.p 
            style={{ y }}
            className="font-display font-bold text-sm md:text-base uppercase tracking-[0.3em] text-zinc-900/60 mb-16 md:mb-24"
          >
            {t("Ready to bring your vision to life?", "Vizyonunuzu hayata geçirmeye hazır mısınız?")}
          </motion.p>
